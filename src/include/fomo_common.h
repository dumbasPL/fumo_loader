...
#define FUMO_DRIVER_VERSION 0x00000004
...
#define IO_DELETE_SHADOW_REQUEST CTL_CODE(FILE_DEVICE_UNKNOWN, 0x8015, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
typedef struct _IO_DELETE_SHADOW_REQUEST_DATA {
    ULONG Pid;
} IO_DELETE_SHADOW_REQUEST_DATA, *PIO_DELETE_SHADOW_REQUEST_DATA;
